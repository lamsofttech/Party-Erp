...
const sections: Section[] = [
    ...
    { title: "Mocks", path: "/gmat/mocks", icon: <ReceiptIcon />, statKey: "gmatMocks", color: "#FF9800" },
    { title: "Exams Booking", path: "/gmat/bookings", icon: <EventIcon />, statKey: "gmatExamsBooking", color: "#9C27B0" },
    { title: "Booked Exams", path: "/gmat/booked-exams", icon: <CalendarTodayIcon />, statKey: "bookedGmatExams", color: "#F44336" },
    { title: "Approve Results", path: "/gmat/approve-results", icon: <CheckCircleIcon />, statKey: "approveGmatResults", color: "#00BCD4" },
    { title: "View Scores", path: "/gmat/view-scores", icon: <VisibilityIcon />, statKey: "viewGmatScores", color: "#673AB7" },
    { title: "Training Resources", path: "/gmat/resources", icon: <SettingsIcon />, statKey: "trainingResources", color: "#E91E63" },
];
