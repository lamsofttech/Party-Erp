...
const GpaApprovals: React.FC = () => {
    ...
    const onboardingType = 'approve-gpa'; // Unique identifier for this page
        ...
        const fetchApplications = async () => {
            try {
                const response = await axios.get(
                    'https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/onboarding/APIs/approve_gpa.php'
                );
                ...
                setSnackbar({ open: true, message: 'Error fetching GPA approvals!', severity: 'error' });
        ...
        <main className="min-h-[80vh] py-4">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
                <DataGrid
                    ...
                    localeText={{ noRowsLabel: 'No GPA approvals found!' }}
