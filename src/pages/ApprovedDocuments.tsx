...
const API_URL = "https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/school-application/APIs/approved_documents_api.php";
...
const ApprovedDocuments: React.FC = () => {
  ...
  // Fetch a specific student's approved documents
