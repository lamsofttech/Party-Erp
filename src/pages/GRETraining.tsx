...
const GRETrainings: React.FC = () => {
    ...
    const API_URL =
        "https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/gre/APIs/gre_phases_api.php";
