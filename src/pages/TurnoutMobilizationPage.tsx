...
// ===== API CONFIG =====
const POST_API_URL = "https://skizagroundsuite.com/API/submit_turnout.php";
const GET_API_URL = "https://skizagroundsuite.com/API/get_turnout.php";
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {isMobile
                  ? "Mission: tap the card, fill the bar 💥"
          ...
          >
            ...
            >
              {/* Top status chips – minimal always, details when toggled */}
              <Box
                sx={{
                  mb: 2,
                  display: "flex",
              ...
              >
                ...
                {showDetails && (
                  <>
                    <Chip
                      color="primary"
                      label={`Score ${countBase.toLocaleString()}`}
                      size={isMobile ? "small" : "medium"}
                    />
                    <Chip
                      variant="outlined"
                      label={
                        typeof registeredRaw === "number"
              ...
              >
                Tap the big card to add voters. 🔋
              </Typography>
              ...
              {/* Controls row – just details toggle + sync */}
              <Box
                sx={{
                  display: "flex",
                  alignItems: "center",
              ...
              {/* MAIN GAME CARD – whole card is clickable */}
              <motion.div
              ...
              >
                <Box
                  ...
                  sx={{
                    ...
                    py: { xs: 2.4, md: 3.2 },
                    mb: 2,
                    bgcolor: remaining > 0 ? "#fff8f3" : "#f1f1f1",
                ...
                >
                  <Typography
                    ...
                    sx={{
                      fontWeight: 800,
                      mb: 0.5,
                      color: remaining > 0 ? "#d4142d" : "text.disabled",
                    }}
                  >
                    {remaining > 0 ? "+1" : "MAXED"}
                  </Typography>
                  ...
                  >
                    {remaining > 0
                      ? "Tap anywhere on this card to add 1 voter."
                      : "Cap reached for this station."}
                  </Typography>
                  <Typography
                    variant="body2"
                    color="text.secondary"
                  ...
                  >
                    Score:{" "}
                    <strong>{countBase.toLocaleString()}</strong> • Remaining:{" "}
              ...
              {/* Quick increment buttons – light & simple */}
