...
const API_URL = "https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/members/APIs/get_members.php";
...
export default function FullMembers() {
    ...
    const columnMapping: Record<keyof Student, string> = {
        ...
        phone: "m.phone",
        country: "m.country",
        enrollmentDate: "m.date_enlored",
        programOption: "m.program_option",
        reportStatus: "m.report_status",
    };

    const [orderBy, setOrderBy] = useState<keyof Student>("enrollmentDate");
        ...
        try {
            ...
            if (data.status === "success" && Array.isArray(data.data)) {
                const studentsData: Student[] = data.data.map((student: any) => ({
                    ...
                    email: student.email || "",
                    phone: student.phone || "",
                    country: student.country || "Unknown", // Handle missing 'country' field
    ...
    const membershipType = "full-members";

    return (
        <div className="my-10">
            <div className="bg-[linear-gradient(0deg,#2164A6_80.26%,rgba(33,100,166,0)_143.39%)] rounded-xl mb-4">
                <p className="font-bold text-[24px] text-white dark:text-white py-4 text-center">Full Members Table</p>
            </div>
