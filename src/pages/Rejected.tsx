...
const RejectedSchoolApplications: React.FC = () => {
    const [applications, setApplications] = useState<Application[]>([]);
    const [filteredApplications, setFilteredApplications] = useState<Application[]>([]);
    const [searchQuery, setSearchQuery] = useState("");

    const API_URL = "https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/school-application/APIs/rejected_applications_api.php";
    ...
    const fetchApplications = async () => {
        try {
            const response = await axios.get(`${API_URL}?action=get_rejected_applications`);
    ...
    const handleExportExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Rejected Applications");
        XLSX.writeFile(workbook, "rejected_school_applications.xlsx");
    };
...
export default RejectedSchoolApplications;