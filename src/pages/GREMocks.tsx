...
const GREMocks: React.FC = () => {
  ...
  const API_URL =
    "https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/gre/APIs/gre_mocks_api.php";
