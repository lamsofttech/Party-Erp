...
const GpaCalculations: React.FC = () => {
    // State variables
    ...
    const API_URL = "https://finkapinternational.qhtestingserver.com/login/main/ken/student-management/school-application/APIs/calculate_gpa_api.php";
                ...
                return (
                    <Box>
                        <Tooltip title="Calculate GPA" arrow>
                            <IconButton
                                component={Link}
                                to={`/school-admission/GPA-dashboard/GPA-calculation/${fullName}?id=${id}`}
                            >
                                            ...
                                            <div className="card-header">
                                                <div className="bg-[linear-gradient(0deg,#2164A6_80.26%,rgba(33,100,166,0)_143.39%)] rounded-xl mb-4">
                                                    <p className="font-bold text-[24px] text-white dark:text-white py-4 text-center">
                                                        GPA Calculations ({applications.length})
                                                    </p>
                                                </div>
...
export default GpaCalculations;